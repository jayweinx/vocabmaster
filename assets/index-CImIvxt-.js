import{a as e,i as t,n,r,t as i}from"./src-znZ1oyik.js";var a=e(t(),1),o=r(),s=n(),c=document.getElementById(`root`);try{(0,o.createRoot)(c).render((0,s.jsx)(a.StrictMode,{children:(0,s.jsx)(i,{})}))}catch(e){console.error(`Unable to start Vocab Master.`,e),c?.classList.remove(`app-loading`),c&&(c.innerHTML=`
